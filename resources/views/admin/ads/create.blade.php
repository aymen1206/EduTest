                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="post" action="{{url('admin/ads/')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="title_en" placeholder="عنوان الاعلان بالانجليزية" required class="form-control form-control-line" value="{{old('title_en')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control" name="text_en" required rows="3" placeholder=" تفاصيل الاعلان بالانجليزية">{{old('text_en')}}</textarea>
