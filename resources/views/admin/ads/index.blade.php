...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 align-self-center">
            ...
            <a href="{{url('admin/ads/create')}}" class="btn btn-primary float-right text-white"> <span class="fa fa-plus-square"></span> @lang('lang.add_new') </a>
                      ...
                      <table id="file_export" class="table table-striped table-bordered display">
                            <thead>
                                <tr class="footable-header">
                                    ...
                                    <th class="text-center"> عنوان الاعلان بالانجليزية </th>
                            ...
                            @foreach($data as $dt)
                                <tr>
                                    ...
                                    <td class="text-center">
                                      <a href="{{url('admin/ads/'.$dt->id.'/edit')}}" title="@lang('lang.edit')" class="btn btn-sm btn-warning"> <i class="fa fa-edit"></i> @lang('lang.edit')</a>
                                      <a href="{{url('admin/ads/'.$dt->id.'/delete')}}" title="@lang('lang.delete')" class="btn btn-sm btn-danger delete-confirm"> <i class="fa fa-trash"></i> @lang('lang.delete') </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
