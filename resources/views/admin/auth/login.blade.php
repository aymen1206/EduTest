...
@section('form')
    <div id="loginform">
        <div class="logo">
            ...
            <h5 class="font-medium mb-3 mt-3">@lang('lang.Sign_In_to_Admin')</h5>
        </div>
        <!-- Form -->
        <div class="row">
            <div class="col-12">
                ...
                <form method="POST" dir="rtl" action="{{ route('admin.login') }}" aria-label="@lang('lang.Login')">
                    @csrf
                    ...
                    <div class="col-12">
                        ...
                        @if (Route::has('admin.password.request'))
                            <a class="btn btn-link text-right float-right" style="width: 100%; text-align: right !important;" href="{{ route('admin.password.request') }}">
