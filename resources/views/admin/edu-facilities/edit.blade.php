    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">المشتركين @lang('lang.update')</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="post" action="{{url('admin/edu-facilities/'.$data->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control" name="about_en" required rows="5" placeholder="@lang('lang.about') بالانجليزية">{{$data->about_en}}</textarea>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control" name="type_id" required aria-label="Default select example">
                                            ...
                                            @foreach($data2 as $dt)
                                                <option @if($data->facility_type == $dt->id) selected @endif value="{{$dt->id}}"> {{$dt->name}} </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-md-12"> الخدمة المقدمة \ المرحلة التعليمية </label>
                                ...
                                <div class="col-md-12">
                                   <select name="city" required class="form-control p-2">
                                    @foreach(DB::table('cities')->get() as $city)
                                        <option @if($data->city == $city->id) selected @endif value="{{ $city->id }}">{{ $city->nameAr }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1" class="col-md-12"> العنوان بالتفصيل</label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1" class="col-md-12"> العنوان بالتفصيل بالانجليزية</label>
                                <div class="col-md-12">
