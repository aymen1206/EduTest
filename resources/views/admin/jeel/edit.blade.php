    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">@lang('lang.jeel')</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/admin')}}">@lang('lang.home')</a></li>
                            <li class="breadcrumb-item"><a href="{{url('/admin/jeel')}}">@lang('lang.jeel')</a></li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('lang.jeel')</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="post" action="{{url('admin/jeel')}}">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="select2-with-tokenizer" class="col-md-12"> المدارس المسموح لها بالتقسيط مع جيل </label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-12"> التقسيط عن طريق جيل </label>
                                <div class="col-md-12">
