...
{{--                            --}}
{{--                            <div class="form-group">--}}
{{--                                <label class="col-md-12"> iso </label>--}}
{{--                                <div class="col-md-12">--}}
{{--                                    <input type="text" name="iso" placeholder=" شعار ال iso الخاص باللغة مثل ar - en " required class="form-control form-control-line" value="{{$data->iso}}">--}}
