...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 align-self-center">
            <h4 class="page-title"> اللغات</h4>
{{--            <a href="{{url('admin/languages/create')}}" class="btn btn-primary float-right text-white"> <span class="fa fa-plus-square"></span> @lang('lang.add_new') </a>--}}
                            ...
                            @foreach($data as $dt)
                                <tr>
                                    ...
                                    <td class="text-center">
                                      <a href="{{url('admin/languages/'.$dt->id.'/edit')}}" title="@lang('lang.edit')" class="btn btn-sm btn-warning"> <i class="fa fa-edit"></i> @lang('lang.edit')</a>
{{--                                      <a href="{{url('admin/languages/'.$dt->id.'/delete')}}" title="@lang('lang.delete')" class="btn btn-sm btn-danger delete-confirm"> <i class="fa fa-trash"></i> @lang('lang.delete') </a>--}}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
