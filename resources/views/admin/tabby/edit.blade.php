    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">@lang('lang.edit_tabby')</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/admin')}}">@lang('lang.home')</a></li>
                            <li class="breadcrumb-item"><a href="{{url('/admin/tabby')}}">@lang('lang.tabby')</a></li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('lang.edit_tabby')</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="post" action="{{url('admin/tabby')}}">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="select2-with-tokenizer" class="col-md-12"> المدارس المسموح لها بالتقسيط مع تابي </label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-12"> التقسيط عن طريق تابي </label>
                                <div class="col-md-12">
