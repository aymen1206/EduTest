...
@section('title')
   انواع المنشئات التعليمية @lang('lang.update')
@endsection
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">انواع المنشئات التعليمية @lang('lang.update')</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/admin')}}">@lang('lang.home')</a></li>
                            <li class="breadcrumb-item"><a href="{{url('/admin/types')}}">انواع المنشئات التعليمية</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="post" action="{{url('admin/types/'.$data->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
