                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a
                                        href="{{url('/edu-facility/finance')}}">@lang('lang.Profile_finance_settings')</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="post"
                              action="{{url('edu-facility/finance/update')}}" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <div class="alert alert-danger">
                                ...
                                <ul>
                                    <li> يجب التأكد من ان كل الحقول في صفحة البروفايل تم ادخالها بشكل صحيح <a target="_blank" href="{{ url
