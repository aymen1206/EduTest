    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <a class="btn btn-primary btn-sm search1" style="background:#19bab2; border: none; float:left" href="{{$_SERVER['REQUEST_URI'].'&map=false'}}"> <i class="fa fa-list" aria-hidden="true"></i> @lang('lang.display_lists') </a>
            </div>
            <div class="col-sm-6 col-xs-12">
                <a class="btn btn-primary btn-sm search1" style="background:#19bab2; border: none" href="{{$_SERVER['REQUEST_URI'].'&map=true'}}"> <i class="fa fa-map-marker" aria-hidden="true"></i> @lang('lang.display_map') </a>
            </div>
        </div>
                            ...
                            <ul class="list-group">
                                <li
                                    ...
                                    <a style="width: 100%" style="z-index: 1000"
                                        href="{{$_SERVER['REQUEST_URI'].'&facility_type='}}">
                                ...
                                <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category">
                                        <a style="width: 100%" href="{{$_SERVER['REQUEST_URI'].'&facility_type=18'}}">
                                    ...
                                    <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category">
                                        <a style="width: 100%" href="{{$_SERVER['REQUEST_URI'].'&facility_type=2'}}">
                                    ...
                                    <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category">
                                        <a style="width: 100%" href="{{$_SERVER['REQUEST_URI'].'&facility_type=1'}}">
                                    ...
                                    <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category">
                                        <a style="width: 100%" href="{{$_SERVER['REQUEST_URI'].'&facility_type=3'}}">
                        ...
                        <div class="py-3">
                            ...
                            <ul class="list-group">
                                <li
                                    class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category">
                                    <a style="width: 100%" style="z-index: 1000"
                                        href="{{$_SERVER['REQUEST_URI'].'&subscription='}}">
                                ...
                                <li
                                    class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category">
                                    <a style="width: 100%" style="z-index: 1000"
                                        href="{{$_SERVER['REQUEST_URI'].'&subscription='.$subscription->id}}">
                        ...
                        <div class="py-3">
                            ...
                            <form class="rating">
                                ...
                                <div class="form-inline d-flex align-items-center py-2">
                                    <label class="tick">
                                        <a style="width: 100%" style="z-index: 1000"
                                            href="{{$_SERVER['REQUEST_URI'].'&rate=5'}}">
                                ...
                                <div class="form-inline d-flex align-items-center py-2">
                                    <label class="tick">
                                        <a style="width: 100%" style="z-index: 1000"
                                            href="{{$_SERVER['REQUEST_URI'].'&rate=4'}}">
                                ...
                                <div class="form-inline d-flex align-items-center py-2">
                                    <label class="tick">
                                        <a style="width: 100%" style="z-index: 1000"
                                            href="{{$_SERVER['REQUEST_URI'].'&rate=3'}}">
                                ...
                                <div class="form-inline d-flex align-items-center py-2">
                                    <label class="tick">
                                        <a style="width: 100%" style="z-index: 1000"
                                            href="{{$_SERVER['REQUEST_URI'].'&rate=2'}}">
                                ...
                                <div class="form-inline d-flex align-items-center py-2">
                                    <label class="tick">
                                        <a style="width: 100%" style="z-index: 1000"
                                            href="{{$_SERVER['REQUEST_URI'].'&rate=1'}}">
