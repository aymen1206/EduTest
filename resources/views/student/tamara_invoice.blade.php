                                ...
                                <div id="printdiv" class="col-md-12">
                                    <div class="invoice-wrapper mb-5" style="position: relative">
                                        ...
                                        <div class="intro mt-3">
                                            ...
                                            <h4 class="text-center">عملية تقسيط ناجحة من تمارا</h4>
                                        </div>
                                        <div class="payment-info">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <span>رقم الطلب</span>
                                                    <strong class="mb-2">{{ $invoice->order_id }}</strong>
                                                    <span>حالة الطلب </span>
                                                    <strong class="mb-2"> {{ $invoice->status }} </strong>
                                                    <span>تاريخ الطلب </span>
                                                    <strong> {{ $invoice->created_at }} </strong>
                                                </div>
                                                <div class="col-sm-6 text-right">
                                                    <span> طريقة الدفع </span>
                                                    <strong class="mb-2"> الدفع بالتقسيط </strong>
                                                    <span>عدد الاقساط </span>
                                                    <strong class="mb-2"> {{ $invoice->instalments }} </strong>
                                                    <span> اول قسط (تم دفعه)  </span>
                                                    <strong>{{ $invoice->paid_amount->amount }} @lang('lang.sar')</strong>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="payment-details">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <strong>
                                                        {{ $invoice->consumer->first_name.' '
                                                        .$invoice->consumer->last_name }}
                                                    </strong>
                                                    <p>
                                                        {{ $invoice->consumer->phone_number }}
                                                        <br>
                                                        <a href="#">
                                                            {{ $invoice->consumer->email }}
                                                        </a>
                                                    </p>
                                                </div>
                                                <div class="col-sm-6 text-right">
                                                ...
                                                <div class="col-sm-12">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-caption="@lang('lang.stage')"> {{ lng($order->pricelist->_type,'name') }}
                                                                , {{ lng($order->pricelist->_stage,'name') }}</td>
                                                            <td data-caption="@lang('lang.payment_method')"> {{ lng($order->pricelist->subscriptionperiod,'name')  }}</td>
                                                            <td data-caption="@lang('lang.price')"> {{
                                                            $invoice->total_amount->amount }} @lang('lang.sar')</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="line-items">
                                            ...
                                            <div class="total text-right">
                                                <div class="field">
                                                    @lang('lang.price') :
                                                    <span>{{ $invoice->total_amount->amount }} @lang('lang.sar')</span>
                                                </div>
                                                <div class="field">
                                                    تم دفع كقسط اول :
                                                    <span>{{ $invoice->paid_amount->amount }} @lang('lang.sar')</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
